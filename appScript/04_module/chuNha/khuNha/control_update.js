...
{
    const khu = (APP.cache.khuNha || []).find(function(khu)
    {
        ...
        .withSuccessHandler(
            function(ketQua)
            {
                ...
                if (ketQua)
                {
                    ...
                    if (ketQua.data && APP.cache && Array.isArray(APP.cache.khuNha))
                    {
                        const viTri = APP.cache.khuNha.findIndex(
                            function(dong)
                            {
                        ...
                        if (viTri !== -1)
                        {
                            APP.cache.khuNha[viTri] = ketQua.data;
                        }
                    }
